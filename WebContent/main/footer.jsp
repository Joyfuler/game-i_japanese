	...
	<footer id = "main_footer">
            <div class="footer bg-dark text-secondary px-1 text-center">
                ...
                <div class="col-lg-6 mx-auto">
                    ...
                    <p class="fs-6">연락처:063-300-0909 | 팩스:02-3537-0366 | 문의메일 <a href="mailto:jpju99@gmail.com" style="color: #a3aa3b;">desk@Game-i.com</a></p>                                          
                    <p class="fs-6">Copyright ⓒ Game-i All Rights Reserved.</p>
                </div>
             </div>   
         </footer>              
