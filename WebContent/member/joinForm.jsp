					...
					<div class = "join_background">
						<table class="table01">							
							<tbody>
								<tr>
									<th>ID </th>
									<td><input id="mid" name="mid" type="text" maxlength="20" tabindex="1" autofocus="autofocus">&nbsp;&nbsp;<input type = "button" class = "idChk" value = "중복검사"></td><td><span id = "idConfirmResult" style = "color:red;"></span></td>																										
								</tr>
								<tr>
									<th>닉네임 </th>
									<td><input id="mnickname" name="mnickname" type="text" maxlength = "20" tabindex="2"> 																		
									<br><br></td>
								</tr>								
								<tr>
									<th>비밀번호 </th>
								...
								<tr>
									...
									<td><input id="mpwChk" name="mpwChk" maxlength="20" tabindex="4"
										type="password"><span id = "pwChkResult" style = "color:red;"></span>										
									</td>
								</tr>
								<tr>
									<th>프로필사진 </th>
								...
								<tr>
									...
									<td><input id="memail" name="memail" maxlength="20" tabindex="6"
										type="text"> &nbsp;&nbsp;<button class = "nickChk">중복검사</button>										
									</td>									
								</tr>
								<tr>
									<th>휴대폰번호 </th>
